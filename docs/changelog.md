...
A versao mais recente registrada no changelog da raiz e `0.8.0` (`2026-05-16`). Consulte o [`CHANGELOG.md` completo](https://github.com/iklav-tech/photo-organizer/blob/main/CHANGELOG.md) para o historico completo e detalhes de cada release.
